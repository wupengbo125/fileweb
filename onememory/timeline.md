...
- 2026-09-18 [fw-20260918-a1] 上传改菜单（上传/同步）；新增 /api/sync pull→add→commit→push
- 2026-09-19 18:37 [fw-20260919-a1] 编辑器加 Ctrl/Cmd+S；sync_repo() ThreadPoolExecutor 8 线程并发同步 11 仓
